		 ...
		 */ !(function () {
			...
			(I.version = '2.3.8'),
							...
							s.test(e) &&
								...
								(s = f).test(t) &&
									...
									(s = v).test((e = t))
										...
										: l.test(e) && (e += 'e')));
						return (
							(i = b).test(e) && (e = (t = (R = i.exec(e))[1]) + 'i'),
							(i = S).test(e) &&
								((t = (R = i.exec(e))[1]), (r = R[2]), (i = c).test(t) && (e = t + o[r])),
							(i = E).test(e) &&
								((t = (R = i.exec(e))[1]), (r = R[2]), (i = c).test(t) && (e = t + a[r])),
							(s = L),
							(i = k).test(e)
				...
				(I.TokenSet.fromArray = function (e) {
					for (var t = new I.TokenSet.Builder(), r = 0, n = e.length; r < n; r++)
						t.insert(e[r]);
				...
				(I.TokenSet.fromFuzzyString = function (e, t) {
					for (
						var r = new I.TokenSet(), n = [{ node: r, editsRemaining: t, str: e }];
						n.length;
								...
								for (y = 0; y < u.fields.length; y++) {
									...
									if (
										(u.presence == I.Query.presence.REQUIRED &&
											((c = c.union(S)), void 0 === s[j] && (s[j] = I.Set.complete)),
									...
									} else void 0 === o[j] && (o[j] = I.Set.empty), (o[j] = o[j].union(S));
								}
							}
						}
					...
					for (a = 0; a < F.length; a++) {
						...
						if (O.contains(D) && !R.contains(D)) {
							var A,
								...
								V = n[N.fieldName].similarity(B);
							if (void 0 !== (A = _[D])) (A.score += V), A.matchData.combine(r[N]);
							else {
								var z = { ref: D, score: V, matchData: r[N] };
								(_[D] = z), C.push(z);
							}
						}
					}
				...
				(I.Builder.prototype.createFieldVectors = function () {
					for (
						...
						for (
							...
							void 0 === n[x]
								? ((y = I.idf(this.invertedIndex[x], this.documentCount)), (n[x] = y))
								: (y = n[x]),
								(m =
									(y * ((this._k1 + 1) * v)) /
									(this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[o])) +
										v)),
								(m *= d),
								(m *= f),
	...
	function (e, t, r) {
				...
				function e(e) {
					...
					(this.documents = (function (e) {
						var t,
							...
							n = new Map();
						try {
							for (var o = i(e), u = o.next(); !u.done; u = o.next()) {
								var l = u.value,
									c = s(l.location.split('#'), 2),
									h = c[0],
									d = c[1],
									f = l.location,
									p = l.title,
								...
								if (d) {
									var m = n.get(h);
									m.linked
										? n.set(f, { location: f, title: p, text: y, parent: m })
										: ((m.title = l.title), (m.text = y), (m.linked = !0));
								} else n.set(f, { location: f, title: p, text: y, linked: !1 });
							}
						} catch (e) {
							t = { error: e };
						} finally {
						...
						(this.highlight = (function (e) {
							var t = new RegExp(e.separator, 'img'),
								r = function (e, t, r) {
									return t + '<em>' + r + '</em>';
								};
							return function (i) {
								...
								var s = new RegExp(
									'(^|' +
										e.separator +
										')(' +
										i.replace(/[|\\{}()[\]^$+*?.-]/g, '\\$&').replace(t, '|') +
										')',
									'img'
								);
								return function (e) {
									return n(n({}, e), {
										title: e.title.replace(s, r),
										text: e.text.replace(s, r),
									});
								};
							};
						})(t)),
						(this.index =
							void 0 === l
								? lunr(function () {
										var e, n, s, a, l;
										(u = u || ['trimmer', 'stopWordFilter']), this.pipeline.reset();
										try {
											for (var c = i(u), h = c.next(); !h.done; h = c.next()) {
												var d = h.value;
												this.pipeline.add(lunr[d]);
											}
										} catch (t) {
											e = { error: t };
										} finally {
										...
										1 === t.lang.length && 'en' !== t.lang[0]
											? this.use(lunr[t.lang[0]])
											: t.lang.length > 1 &&
											  this.use((s = lunr).multiLanguage.apply(s, o(t.lang))),
											this.field('title', { boost: 1e3 }),
											this.field('text'),
											this.ref('location');
										try {
											for (var f = i(r), p = f.next(); !p.done; p = f.next()) {
												var y = p.value;
												this.add(y);
											}
										} catch (e) {
								...
								: lunr.Index.load('string' == typeof l ? JSON.parse(l) : l));
				}
				return (
					(e.prototype.query = function (e) {
						...
						if (e)
							try {
								var r = this.index.search(e).reduce(function (e, r) {
										var n = t.documents.get(r.ref);
										if (void 0 !== n)
											if ('parent' in n) {
												var i = n.parent.location;
												e.set(i, o(e.get(i) || [], [r]));
											} else {
												i = n.location;
												e.set(i, e.get(i) || []);
									...
									n = this.highlight(e);
								return o(r).map(function (e) {
									var r = s(e, 2),
										i = r[0],
										o = r[1];
									return {
										article: n(t.documents.get(i)),
										sections: o.map(function (e) {
											return n(t.documents.get(e.ref));
										}),
									};
								});
							} catch (t) {
		...
		function h(e) {
			switch (e.type) {
					...
					return (
						(function (e) {
							var t,
								...
								s = [];
							try {
								for (var a = i(e.lang), u = a.next(); !u.done; u = a.next()) {
									var l = u.value;
									'ja' === l && s.push(n + '/tinyseg.min.js'),
										'en' !== l && s.push(n + '/min/lunr.' + l + '.min.js');
								}
							} catch (e) {
								t = { error: e };
							} finally {
							...
							e.lang.length > 1 && s.push(n + '/min/lunr.multi.min.js'),
								s.length &&
									importScripts.apply(
										void 0,
										o([n + '/min/lunr.stemmer.support.min.js'], s)
									);
						})(e.data.config),
						(l = new c(e.data)),
						{ type: u.READY }
				...
				case u.QUERY:
					return { type: u.RESULT, data: l ? l.query(e.data) : [] };
				default:
