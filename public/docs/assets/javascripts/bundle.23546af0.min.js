!(function (t, e) {
	...
	(function (t) {
		function e(e) {
			for (var r, i, o = e[0], u = e[1], b = e[2], s = 0, O = []; s < o.length; s++)
				(i = o[s]),
		...
		function (t, e, n) {
			...
			function o(t, e) {
				return void 0 === e && (e = document), e.querySelector(t) || void 0;
			}
			function u(t, e) {
				void 0 === e && (e = document);
				var n = o(t, e);
			...
			function v(t) {
				return Object(j.a)(Object(c.a)(t, 'focus'), Object(c.a)(t, 'blur')).pipe(
			...
			function y(t) {
				return Object(j.a)(Object(c.a)(t, 'scroll'), Object(c.a)(window, 'resize')).pipe(
					Object(l.a)(function () {
						return m(t);
					}),
					Object(d.a)(m(t)),
			...
			function g(t) {
				if (!(t instanceof HTMLInputElement)) throw new Error('Not implemented');
				t.select();
			}
			var w = n(0),
				$ = n(74),
			...
			function k(t) {
				return Object(x.a)(function (e) {
					new $.a(function (t) {
						...
						return e({ width: Math.round(n.width), height: Math.round(n.height) });
					}).observe(t);
				}).pipe(
					Object(d.a)(
						(function (t) {
			...
			function L(t, e) {
				return (
					void 0 === e && (e = location),
					t.host === e.host && /^(?:\/[\w-]+)*(?:\/?|\.html)$/i.test(t.pathname)
				);
			}
			function M(t, e) {
				return (
					void 0 === e && (e = location), t.pathname === e.pathname && t.hash.length > 0
				);
			}
			function H() {
			...
			function W() {
				return Object(Y.a)([
					...
					).pipe(Object(l.a)(K), Object(d.a)(K())),
		...
		function (t, e, n) {
			...
			function o(t, e, n) {
				switch (e) {
					...
					case 'd':
						...
						break;
					default:
						'boolean' != typeof n ? t.setAttribute(e, n) : n && t.setAttribute(e, '');
				}
			}
			function u(t, e) {
				var n, r;
				if ('string' == typeof e || 'number' == typeof e) t.innerHTML += e.toString();
				else if (e instanceof Node) t.appendChild(e);
				else if (Array.isArray(e))
					try {
						for (var a = Object(c.k)(e), i = a.next(); !i.done; i = a.next()) {
							u(t, i.value);
						}
					} catch (t) {
						n = { error: t };
			...
			function b(t, e) {
				...
				try {
					for (var h = Object(c.k)(s), v = h.next(); !v.done; v = h.next()) {
						var m = v.value;
						u(j, m);
					}
				} catch (t) {
			...
			function d(t, e) {
				...
				if (void 0 === j[t]) throw new ReferenceError('Invalid translation: ' + t);
		...
		function (t, e, n) {
			...
			function O(t) {
				...
				e.subscribe(function () {
					Object(b.e)('pre > code').forEach(function (t, e) {
						...
						(n.id = '__code_' + e), n.insertBefore(Object(f.a)(n.id), t);
					});
				});
						...
						.pipe(
							Object(p.a)(function (t) {
								return Object(l.a)(document.body).pipe(
									...
									Object(m.a)(e || 2e3),
									Object(o.a)(function (t) {
										return t.removeAttribute('data-md-state');
									}),
									Object(m.a)(400),
									Object(o.a)(function (t) {
			...
			function R(t) {
				...
				var a = Object(b.c)('link[rel="shortcut icon"]');
				void 0 !== a && (a.href = a.href);
				var o = Object(w.a)(document.body, 'click').pipe(
					...
					Object(p.a)(function (t) {
						if (t.target instanceof HTMLElement) {
							...
							if (e && !e.target && Object(b.h)(e))
								return Object(b.g)(e) || t.preventDefault(), Object(l.a)(e);
						}
						return c.a;
					}),
					Object(h.a)(function (t) {
				...
				var u = o.pipe(
					...
					f = Object(w.a)(window, 'popstate').pipe(
						Object(k.a)(function (t) {
							return null !== t.state;
						}),
						Object(h.a)(function (t) {
							return { url: new URL(location.href), offset: t.state };
						}),
						Object(i.a)()
					);
				Object($.a)(u, f)
				...
				u.pipe(Object(E.a)(s)).subscribe(function (t) {
					var e = t.url;
				...
				s.pipe(
					Object(h.a)(function (t) {
						var e = t.response;
						return O.parseFromString(e, 'text/html');
					})
				).subscribe(e);
				var j = Object($.a)(u, f).pipe(Object(E.a)(e));
				j.subscribe(function (t) {
					var e = t.url,
						n = t.offset;
					e.hash && !n ? Object(b.n)(e.hash) : Object(b.p)(n || { y: 0 });
				}),
					j.pipe(Object(L.a)(e)).subscribe(function (t) {
						var e,
							n,
							r = Object(g.h)(t, 2)[1],
							c = r.title,
						...
						try {
							for (
								...
								void 0 !== f && void 0 !== s && Object(b.j)(s, f);
							}
						} catch (t) {
							e = { error: t };
						} finally {
					...
					n.pipe(Object(M.a)(250), Object(T.a)('offset')).subscribe(function (t) {
						var e = t.offset;
						...
						.pipe(
							...
							Object(k.a)(function (t) {
								var e = Object(g.h)(t, 2),
									n = e[0],
									r = e[1];
								return n.url.pathname === r.url.pathname && !Object(b.g)(r.url);
							}),
							Object(h.a)(function (t) {
			...
			function U() {
				var t = Object(b.u)().pipe(
					Object(h.a)(function (t) {
						return Object(g.a)({ mode: Object(b.f)('search') ? 'search' : 'global' }, t);
					}),
					Object(k.a)(function (t) {
						if ('global' === t.mode) {
							var e = Object(b.b)();
					...
					t
						...
						.subscribe(function (t) {
							...
							switch (n.type) {
								...
								case 'Escape':
								case 'Tab':
									Object(b.o)('search', !1), Object(b.k)(r, !1);
									break;
								case 'ArrowUp':
								case 'ArrowDown':
									if (void 0 === a) Object(b.k)(r);
									else {
										var i = Object(g.i)([r], Object(b.e)('[href]', c)),
											o = Math.max(
												0,
				...
				r = n.pipe(
					Object(o.a)(function (e) {
						return t.reduce(function (t, n) {
							var r,
								a = Object(O.c)('[data-md-component=' + n + ']', e);
							return Object(c.a)(
								Object(c.a)({}, t),
								void 0 !== a ? (((r = {})[n] = a), r) : {}
							);
					...
					Object(u.a)(function (e, n) {
						var r, a;
						try {
							for (var i = Object(c.k)(t), o = i.next(); !o.done; o = i.next()) {
								var u = o.value;
								switch (u) {
									case 'announce':
									case 'header-title':
									case 'container':
									case 'skip':
										u in e && void 0 !== e[u] && (Object(O.j)(e[u], n[u]), (e[u] = n[u]));
										break;
									default:
										void 0 !== n[u]
											? (e[u] = Object(O.c)('[data-md-component=' + u + ']'))
											: delete e[u];
								}
							}
						} catch (t) {
		...
		function (t, e, n) {
			...
			var i = n(0),
				...
				b = 'md-search-result__article md-search-result__article--document',
					...
					a = Object(i.i)([e], n).map(function (t) {
						...
						return Object(r.b)(
							...
							Object(r.b)(
								...
								a.length > 0 && Object(r.b)('p', { class: O }, Object(r.g)(a, 320))
							)
						);
					});
			...
			var h = 'md-typeset__scrollwrap',
				v = 'md-typeset__table';
			function m(t) {
				return Object(r.b)('div', { class: h }, Object(r.b)('div', { class: v }, t));
			}
		},
		function (t, e, n) {
			'use strict';
				...
				function t(t) {
					...
					(this.documents = (function (t) {
						var e,
							...
							a = new Map();
						try {
							for (var i = Object(r.k)(t), o = i.next(); !o.done; o = i.next()) {
								var u = o.value,
								...
								if (s) {
									var d = a.get(f);
									d.linked
										? a.set(O, { location: O, title: j, text: l, parent: d })
										: ((d.title = u.title), (d.text = l), (d.linked = !0));
								} else a.set(O, { location: O, title: j, text: l, linked: !1 });
							}
						} catch (t) {
							e = { error: t };
						} finally {
						...
						(this.index =
							void 0 === i
								? lunr(function () {
										var t, c, i, o, u;
										(a = a || ['trimmer', 'stopWordFilter']), this.pipeline.reset();
										try {
											for (var b = Object(r.k)(a), f = b.next(); !f.done; f = b.next()) {
												var s = f.value;
										...
										1 === e.lang.length && 'en' !== e.lang[0]
											...
											: e.lang.length > 1 &&
											  this.use((i = lunr).multiLanguage.apply(i, Object(r.i)(e.lang))),
											this.field('title', { boost: 1e3 }),
											this.field('text'),
											this.ref('location');
										try {
											for (var O = Object(r.k)(n), j = O.next(); !j.done; j = O.next()) {
												var l = j.value;
												this.add(l);
											}
										} catch (t) {
											...
											try {
												j && !j.done && (u = O.return) && u.call(O);
											} finally {
												if (o) throw o.error;
											}
										}
								  })
								: lunr.Index.load('string' == typeof i ? JSON.parse(i) : i));
				}
				t.prototype.query = function (t) {
					var e = this;
					if (t)
						try {
							var n = this.index.search(t).reduce(function (t, n) {
									var c = e.documents.get(n.ref);
									if (void 0 !== c)
										if ('parent' in c) {
											var a = c.parent.location;
											t.set(a, Object(r.i)(t.get(a) || [], [n]));
										} else {
											a = c.location;
											t.set(a, t.get(a) || []);
										}
							...
							console.warn('Invalid query: ' + t + ' – see https://bit.ly/2s3ChXG');
						}
					return [];
				};
			})();
				...
				var n = e.index$,
					...
					d = Object(l.C)(a, { tx$: o }).pipe(
						...
						Object(s.a)(function (t) {
							...
							if (v(o))
								try {
									for (var b = Object(r.k)(o.data), f = b.next(); !f.done; f = b.next()) {
										var s = f.value,
											O = s.article,
											j = s.sections;
										...
										try {
											for (
												var l = ((c = void 0), Object(r.k)(j)), d = l.next();
												!d.done;
												d = l.next()
											) {
												var p = d.value;
												p.location = u + '/' + p.location;
											}
										} catch (t) {
											c = { error: t };
										} finally {
		...
		function (t, e, n) {
			...
			function l(t, e) {
				var n = e.main$,
					a = e.viewport$,
					i = t.parentElement.offsetTop - t.parentElement.parentElement.offsetTop;
				return Object(c.a)([n, a]).pipe(
					Object(o.a)(function (t) {
						var e = Object(r.h)(t, 2),
							...
							o = e[1].offset.y;
						return {
							height: (a = a + Math.min(i, Math.max(0, o - c)) - i),
							lock: o >= c + i,
						};
					}),
				...
				return Object(a.a)(
					...
					Object(s.a)(function (e) {
						var n = Object(r.h)(e, 2),
							...
							i = c.lock,
							o = n[1].height;
						Object(j.c)(t, a), i ? Object(j.d)(t, o) : Object(j.b)(t);
					}),
					Object(o.a)(function (t) {
							...
							Object(o.a)(function (c) {
								if (c) {
									var o = Object(b.e)('.md-nav__link', t),
										j = Object(f.watchSidebar)(t, { main$: n, viewport$: O }).pipe(
											Object(f.applySidebar)(t, { header$: e })
										),
										l = Object(s.watchAnchorList)(o, { header$: e, viewport$: O }).pipe(
											Object(s.applyAnchorList)(o)
										);
									return Object(a.a)([j, l]).pipe(
										Object(u.a)(function (t) {
											var e = Object(r.h)(t, 2);
											return { sidebar: e[0], anchors: e[1] };
										})
									);
								}
								return Object(i.a)({});
		...
		function (t, e, n) {
			...
			function y(t, e) {
				var n,
					...
					p = new Map();
				try {
					for (var h = Object(r.k)(t), m = h.next(); !m.done; m = h.next()) {
						var y = m.value,
					...
					.pipe(
						...
						Object(u.a)(function () {
							...
							return Object(r.i)(p).reduce(function (e, n) {
								for (var a = Object(r.h)(n, 2), i = a[0], o = a[1]; t.length; ) {
									if (!(p.get(t[t.length - 1]).tagName >= o.tagName)) break;
									t.pop();
								}
								for (var u = o.offsetTop; !u && o.parentElement; )
									u = (o = o.parentElement).offsetTop;
								return e.set(Object(c.a)((t = Object(r.i)(t, [i]))), u);
							}, new Map());
						}),
								...
								Object(s.a)(
									function (t, e) {
										for (
											...
											if (!(Object(r.h)(a[0], 2)[1] - o < u)) break;
											c = Object(r.i)(c, [a.shift()]);
										}
										for (; c.length; ) {
											if (!(Object(r.h)(c[c.length - 1], 2)[1] - o >= u)) break;
					...
					.pipe(
						...
						Object(u.a)(function (t) {
							...
							return n.prev.length < c.prev.length
								? {
										prev: c.prev.slice(Math.max(0, n.prev.length - 1), c.prev.length),
										next: [],
								  }
								: {
										prev: c.prev.slice(-1),
										next: c.next.slice(0, c.next.length - n.next.length),
								  };
						})
					);
			}
				...
				return Object(i.a)(
					...
					Object(p.a)(function (t) {
						var e,
							...
							a = t.next;
						try {
							for (var i = Object(r.k)(a), o = i.next(); !o.done; o = i.next()) {
						...
						c.forEach(function (t, e) {
							...
							Object(m.c)(n, e === c.length - 1), Object(m.d)(n, !0);
						});
					}),
					Object(h.a)(function () {
						var e, n;
						try {
							for (var c = Object(r.k)(t), a = c.next(); !a.done; a = c.next()) {
								var i = a.value;
		...
		function (t, e, n) {
			...
			function l(t, e) {
				...
				return Object(c.a)(
					Object(i.a)(function () {
						...
						return (
							l
								.pipe(Object(o.a)(j.c), Object(f.a)(t), Object(s.a)(1))
								.subscribe(l.next.bind(l)),
							Object(a.a)([t, d, h, p]).pipe(
								Object(O.a)(function (t) {
									var e = Object(r.h)(t, 3);
									return { status: e[0], query: e[1], result: e[2] };
								})
							)
						);
					})
				...
				return (
					...
					Object(c.a)(
						Object(i.a)(function (t) {
							var c = (function (t, e) {
								var n = (void 0 === e ? {} : e).transform || h.b,
									c = Object(v.a)(
										Object(m.a)(t, 'keyup'),
										Object(m.a)(t, 'focus').pipe(Object(y.a)(1))
									).pipe(
										Object(O.a)(function () {
											return n(t.value);
										}),
							...
							return (
								...
								c.pipe(Object(d.a)('focus')).subscribe(function (t) {
									var e = t.focus;
			...
			function S() {
				return Object(c.a)(
					Object(i.a)(function (t) {
						return (function (t) {
							return Object(m.a)(t, 'click').pipe(Object(u.a)(void 0));
						})(t).pipe(
						...
						return (
							e[1].value
								? (function (t, e) {
										switch (e) {
											case 0:
												t.textContent = Object(R.f)('search.result.none');
												break;
											case 1:
												t.textContent = Object(R.f)('search.result.one');
												break;
											default:
												t.textContent = Object(R.f)('search.result.other', e.toString());
										}
								  })(f, n.length)
								: (function (t) {
										t.textContent = Object(R.f)('search.result.placeholder');
								  })(f),
							n
						);
					}),
						...
						return o.pipe(
							...
							Object(L.a)(function (n) {
								for (
									...
									n < e.length &&
									(P(b, Object(H.b)(e[n++])), !(r.scrollHeight - r.offsetHeight > 16));
				...
				return Object(c.a)(
					Object(i.a)(function (t) {
						var e = t.parentElement,
							...
							a = Object(p.s)(e).pipe(
								Object(O.a)(function (t) {
									return t.y >= e.scrollHeight - e.offsetHeight - 16;
								}),
								Object(g.a)(),
								Object(o.a)(C.a)
							);
								...
								return m.pipe(
									...
									Object(c.a)(
										...
										Object(o.a)(function (t) {
											var n = t.active;
											!(function (t, e) {
												t.setAttribute('data-md-state', e ? 'shadow' : '');
											})(e, n);
										}),
										Object(h.a)(function () {
											!(function (t) {
					...
					Object(c.a)(
						Object(a.a)(function (t) {
							return (function (t, e) {
								var n = e.header$,
									r = e.viewport$,
									c = n.pipe(Object(O.a)('height'), Object(j.a)(), Object(l.a)(1)),
									o = c.pipe(
										Object(a.a)(function () {
											return Object(v.t)(t).pipe(
												Object(d.a)(function (e) {
													var n = e.height;
													return { top: t.offsetTop, bottom: t.offsetTop + n };
												})
											);
										}),
										Object(i.a)('bottom'),
								...
								return Object(f.a)([c, o, r]).pipe(
									Object(d.a)(function (t) {
										...
										return {
											...
											height: (u = Math.max(
												0,
												u - Math.max(0, c - o, n) - Math.max(0, u + o - a)
											)),
											active: c - n <= o,
										};
									}),
							...
							(function (t) {
								return Object(r.a)(
									...
									Object(f.a)(function (e) {
										var n = e.hidden;
										!(function (t, e) {
											t.setAttribute('data-md-state', e ? 'hidden' : '');
										})(t, n);
									}),
									Object(s.a)(function () {
										!(function (t) {
						...
						var y = (function (t, e) {
								return e.document$.pipe(
									Object(o.a)(function () {
										...
										return ['sticky', '-webkit-sticky'].includes(e.position);
									}),
									Object(f.a)(),
									Object(i.a)(function (e) {
										return e
											? Object(j.t)(t).pipe(
													Object(o.a)(function (t) {
														return { sticky: !0, height: t.height };
													})
											  )
											: Object(d.a)({ sticky: !1, height: 0 });
									}),
									Object(O.a)(1)
								);
							})(t, { document$: e }),
							g = Object(l.b)('main').pipe(
								Object(o.a)(function (t) {
									return Object(j.c)('h1, h2, h3, h4, h5, h6', t);
								}),
								Object(u.a)(function (t) {
									return void 0 !== t;
								}),
								...
								Object(i.a)(function (t) {
									var e = Object(r.h)(t, 2),
										a = e[0],
										i = e[1];
									return Object(j.B)(a, { header$: y, viewport$: n }).pipe(
										Object(o.a)(function (t) {
											return t.offset.y >= a.offsetHeight ? 'page' : 'site';
										}),
										Object(f.a)(),
										(function (t) {
											return Object(c.a)(
												...
												Object(v.a)(function (e) {
													!(function (t, e) {
														t.setAttribute('data-md-state', e ? 'active' : '');
													})(t, 'page' === e);
												}),
												Object(m.a)(function () {
													!(function (t) {
					...
					Object(a.a)(function (t) {
						return j.pipe(
							Object(a.a)(function (a) {
								return a
									? Object(u.B)(t, { header$: e, viewport$: n }).pipe(
											Object(i.a)(function (t) {
					...
					Object(a.a)(function (t) {
						return b.pipe(
							Object(a.a)(function (r) {
								return r
									? Object(o.watchSidebar)(t, { main$: n, viewport$: u }).pipe(
											Object(o.applySidebar)(t, { header$: e }),
											Object(i.a)(function (t) {
												return { sidebar: t };
											})
									  )
		...
		function (t, e, n) {
			...
			var H = n(30),
				R = n(4);
			function P(t) {
				switch (Object(r.h)(t.match(/(git(?:hub|lab))/i) || [], 1)[0].toLowerCase()) {
					case 'github':
						var e = Object(r.h)(t.match(/^.+github\.com\/([^\/]+)\/?([^\/]+)/i), 3);
						return (function (t, e) {
							return Object(j.a)({
								url:
									void 0 !== e
										? 'https://api.github.com/repos/' + t + '/' + e
								...
								Object(d.a)(function (t) {
									if (void 0 !== e) {
										var n = t.stargazers_count,
											r = t.forks_count;
										return Object(o.a)([
											Object(R.e)(n || 0) + ' Stars',
											Object(R.e)(r || 0) + ' Forks',
										]);
									}
									var c = t.public_repos;
									return Object(o.a)([Object(R.e)(c || 0) + ' Repositories']);
								})
							);
						})(e[1], e[2]);
					case 'gitlab':
						var n = Object(r.h)(t.match(/^.+?([^\/]*gitlab[^\/]+)\/(.+?)\/?$/i), 3);
						return (function (t, e) {
							return Object(j.a)({
								url: 'https://' + t + '/api/v4/projects/' + encodeURIComponent(e),
								responseType: 'json',
							}).pipe(
								Object(w.a)(function (t) {
									return 200 === t.status;
								...
								Object(T.a)(function (t) {
									var e = t.star_count,
										n = t.forks_count;
									return [Object(R.e)(e) + ' Stars', Object(R.e)(n) + ' Forks'];
								})
							);
						})(n[1], n[2]);
					default:
			...
			function U(t, e) {
				t.setAttribute('data-md-state', 'lock'), (t.style.top = '-' + e + 'px');
			}
			function q(t) {
			...
			function N(t) {
				if (!Object(R.d)(t))
					throw new SyntaxError('Invalid configuration: ' + JSON.stringify(t));
				var e = Object(x.q)(),
					n = Object(x.v)(),
					N = Object(x.w)(t.base, { location$: n }),
					I = Object(x.x)(),
					z = Object(x.A)(),
					V = Object(x.y)('(min-width: 960px)'),
					D = Object(x.y)('(min-width: 1220px)');
				Object(k.setupComponents)(
					[
						'announce',
						'container',
						'header',
				...
				!(function (t) {
					var e = t.document$,
						...
						c = e.pipe(
							Object(T.a)(function () {
								return Object(x.e)('details');
							})
						);
					Object(O.a)(
						Object(x.y)('print').pipe(Object(w.a)(C.a)),
						Object(s.a)(window, 'beforeprint')
					)
						.pipe(Object(A.a)(c))
						.subscribe(function (t) {
							var e, n;
					...
					{ document$: e }.document$
						.pipe(
							Object(_.a)(1),
							Object(y.a)(Object(k.useComponent)('container')),
							Object(T.a)(function (t) {
								var e = Object(r.h)(t, 2)[1];
								return Object(x.e)('script', e);
							})
						)
						.subscribe(function (t) {
							var e, n;
							try {
								for (var c = Object(r.k)(t), a = c.next(); !a.done; a = c.next()) {
									var i = a.value;
									if (i.src || /(^|\/javascript)$/i.test(i.type)) {
										var o = Object(x.a)('script'),
											u = i.src ? 'src' : 'textContent';
										(o[u] = i[u]), Object(x.j)(i, o);
									}
								}
							} catch (t) {
								e = { error: t };
					...
					(function (t) {
						t.document$
							.pipe(
								Object(T.a)(function () {
									return Object(x.d)('.md-source[href]');
								}),
								Object(d.a)(function (t) {
									var e = t.href;
									return Object(R.a)('' + Object(R.c)(e), function () {
										return P(e);
									});
								}),
								Object(h.a)(function () {
							...
							.subscribe(function (t) {
								...
								try {
									for (
										var c = Object(r.k)(Object(x.e)('.md-source__repository')),
											a = c.next();
										!a.done;
										a = c.next()
									) {
										...
										i.hasAttribute('data-md-state') ||
											(i.setAttribute('data-md-state', 'done'),
											i.appendChild(Object(H.c)(t)));
									}
								} catch (t) {
									e = { error: t };
								} finally {
					...
					(function (t) {
						...
						e.pipe(
							Object(T.a)(function () {
								return Object(x.e)('table:not([class])');
							})
						).subscribe(function (t) {
							var e, c;
							try {
								for (var a = Object(r.k)(t), i = a.next(); !i.done; i = a.next()) {
									var o = i.value;
									Object(x.j)(o, n), Object(x.j)(n, Object(H.d)(o));
								}
							} catch (t) {
								e = { error: t };
							} finally {
					...
					(function (t) {
						var e = t.document$.pipe(
							Object(T.a)(function () {
								return Object(x.e)('[data-md-scrollfix]');
							}),
							Object(l.a)(1)
						);
						e.subscribe(function (t) {
							...
							try {
								for (var c = Object(r.k)(t), a = c.next(); !a.done; a = c.next()) {
									a.value.removeAttribute('data-md-scrollfix');
								}
							} catch (t) {
								e = { error: t };
							} finally {
								...
								.pipe(
									Object(d.a)(function (t) {
										return O.a.apply(
											...
											Object(r.i)(
												t.map(function (t) {
													return Object(s.a)(t, 'touchstart', { passive: !0 }).pipe(
														Object(L.a)(t)
													);
												})
											)
				...
				var Y = Object(S.f)(),
					J = Object(S.e)({ document$: e, dialog$: Y }),
					K = Object(k.useComponent)('header').pipe(
						Object(k.mountHeader)({ document$: e, viewport$: z }),
						Object(l.a)(1)
					),
					Q = Object(k.useComponent)('main').pipe(
						Object(k.mountMain)({ header$: K, viewport$: z }),
						Object(l.a)(1)
					),
					F = Object(k.useComponent)('navigation').pipe(
						Object(k.mountNavigation)({ header$: K, main$: Q, viewport$: z, screen$: D }),
						Object(l.a)(1)
					),
					W = Object(k.useComponent)('toc').pipe(
						Object(k.mountTableOfContents)({
							header$: K,
							main$: Q,
							viewport$: z,
							tablet$: V,
					...
					X = Object(k.useComponent)('tabs').pipe(
						Object(k.mountTabs)({ header$: K, viewport$: z, screen$: D }),
						Object(l.a)(1)
					),
					Z = Object(k.useComponent)('hero').pipe(
						Object(k.mountHero)({ header$: K, viewport$: z }),
						Object(l.a)(1)
					),
					G = Object(a.a)(function () {
						var e = t.search && t.search.index ? t.search.index : void 0,
							n =
								void 0 !== e
									? Object(i.a)(e)
									: N.pipe(
											Object(d.a)(function (t) {
												return Object(j.a)({
													url: t + '/search/search_index.json',
													responseType: 'json',
													withCredentials: !0,
												}).pipe(Object(p.a)('response'));
											})
									  );
						return Object(o.a)(Object(S.i)(t.search.worker, { base$: N, index$: n }));
					}).pipe(
						Object(d.a)(function (e) {
							var n = Object(k.useComponent)('search-query').pipe(
									Object(k.mountSearchQuery)(e, { transform: t.search.transform }),
									Object(l.a)(1)
								),
								r = Object(k.useComponent)('search-reset').pipe(
									Object(k.mountSearchReset)(),
									Object(l.a)(1)
								),
								c = Object(k.useComponent)('search-result').pipe(
									Object(k.mountSearchResult)(e, { query$: n }),
									Object(l.a)(1)
								);
							return Object(k.useComponent)('search').pipe(
								Object(k.mountSearch)(e, { query$: n, reset$: r, result$: c }),
								Object(l.a)(1)
							);
						}),
						Object(h.a)(function () {
							return (
								Object(k.useComponent)('search').subscribe(function (t) {
									return (t.hidden = !0);
								}),
								u.a
							);
				...
				I.pipe(
					Object(v.a)(function () {
						return Object(x.o)('search', !1);
					}),
					Object(m.a)(125)
				).subscribe(function (t) {
					return Object(x.n)('#' + t);
				}),
					Object(b.a)([Object(x.z)('search'), V])
						.pipe(
							Object(y.a)(z),
							Object(d.a)(function (t) {
								var n = Object(r.h)(t, 2),
						...
						.subscribe(),
					Object(s.a)(document.body, 'click')
						.pipe(
							Object(w.a)(function (t) {
								return !(t.metaKey || t.ctrlKey);
							}),
					...
					t.features.includes('instant') &&
						...
						Object(S.g)({ document$: e, location$: n, viewport$: z }),
					B.pipe(
						Object(w.a)(function (t) {
						...
						try {
							for (
								var n = Object(r.k)(Object(x.e)('.headerlink')), c = n.next();
								!c.done;
								c = n.next()
							) {
				...
				return O.a.apply(void 0, Object(r.i)(Object(c.a)(tt))).subscribe(), tt;
			}
